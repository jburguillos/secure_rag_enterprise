...
- `UI_DEFAULT_CHAT_MODEL` (default from `OLLAMA_CHAT_MODEL`)
- `UI_MODEL_OPTIONS` (comma-separated model selector options in sidebar)
- `UI_DEFAULT_TEMPERATURE` (default `0.0`)
- `UI_DEFAULT_TOP_P` (default `0.9`)
- `UI_DEFAULT_MAX_TOKENS` (default `384`)
